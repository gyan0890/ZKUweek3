...
template MastermindVariation() {
    ...
    component finalHashEquality = IsEqual();
    finalHashEquality.in[0] <== pubSolnHash;
    finalHashEquality.in[1] <== poseidon.out;
    solnHashOut <== finalHashEquality.out;
